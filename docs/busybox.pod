...
Currently available applets include:
	...
	nbd-client, nc, netstat, newcmd, nice, nmeter, nohup, nslookup,
	ntpd, od, openvt, passwd, patch, pgrep, pidof, ping, ping6,
	pipe_progress, pivot_root, pkill, pmap, popmaildir, poweroff,
	powertop, pr, printenv, printf, ps, pscan, pwd, raidautorun, rdate,
...
pr [FILE]Print selected file with line no
None
